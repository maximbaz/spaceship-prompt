...
SPACESHIP_TOX_FAIL_ICON="${SPACESHIP_TOX_FAIL_ICON="\u2718 "}"
SPACESHIP_TOX_OK_ICON="${SPACESHIP_TOX_OK_ICON="\u2714 "}"
...
spaceship_tox() {
  ...
  [[ "${SPACESHIP_ASYNC_RESULTS[spaceship_async_job_tox]}" == "OK" ]] && { SPACESHIP_TOX_COLOR="${SPACESHIP_TOX_COLOR_OK}"; SPACESHIP_TOX_SYMBOL="${SPACESHIP_TOX_OK_ICON}" }
  [[ "${SPACESHIP_ASYNC_RESULTS[spaceship_async_job_tox]}" == "FAIL" ]] && { SPACESHIP_TOX_COLOR="${SPACESHIP_TOX_COLOR_FAIL}"; SPACESHIP_TOX_SYMBOL="${SPACESHIP_TOX_FAIL_ICON}" }
